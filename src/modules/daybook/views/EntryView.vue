<template>
  <div class="entry-title d-flex justify-content-between p-2">
    ...
    <div>
      ...
      <button class="btn btn-primary mx-2">
        Subir foto <i class="fa fa-upload-alt"></i>
      </button>
    </div>
  </div>
  <hr />
  ...
  <Fab icon="fa-save" />
  <img
    src="https://images.unsplash.com/photo-1661856607957-32059f8428b2?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80"
    alt="entry-picture"
    class="img-thumbnail"
  />
</template>
